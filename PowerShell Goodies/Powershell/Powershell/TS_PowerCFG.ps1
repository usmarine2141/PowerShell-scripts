...
#********************
    ...
    if(($OSVersion.Major -eq 6) -and ($OSVersion.Minor -ge 2))      #Win 8
	{
		if((Get-WmiObject -Class Win32_Battery ) -ne $null)   #if system has a battery
		{
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUk+61xLwteGq61MPe+ppo+iCP
# +2GgghV6MIIEuzCCA6OgAwIBAgITMwAAAFrtL/TkIJk/OgAAAAAAWjANBgkqhkiG
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSwXhJkBqZIKUFH
# 7YGiai6RbyxT9jCBgAYKKwYBBAGCNwIBDDFyMHCgVoBUAEMAVABTAF8ATgBlAHQA
# dwBvAHIAawBpAG4AZwBfAE0AYQBpAG4AXwBnAGwAbwBiAGEAbABfAFQAUwBfAFAA
# bwB3AGUAcgBDAEYARwAuAHAAcwAxoRaAFGh0dHA6Ly9taWNyb3NvZnQuY29tMA0G
# CSqGSIb3DQEBAQUABIIBAHdhbZ4R3J4FcpsNfWbtU73WDCtRirmyNxXxTpGcbt/6
# wC4DwPnkQkRXaGy+Mtt3os4+mcLOXbF5l6C5McP12TlxJ9l0aw3q706VGER0G3ge
# iEEbAF81GizvmaHQO0goYo6aLsuEKnCnfZYjiTQET4cGTJqJG4qBU+gEZIa9TEU9
# HM37SnlrzF3WXt7lliQx/i8iC7oyzXuwmQ4gCxfq7qp2R7Zp8K4mB59LcTC0Bpe4
# mGARCMQHmhA/NkFAzfqDycMc6f2G/guwNQW90q7IVfDL3bHI8OH3VtUlFpbdl9jr
# EyMsT9SFNnAInLEh6c0kZpMSr1c68Q+f/sqFvmrGi3OhggIoMIICJAYJKoZIhvcN
...
# hvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0xNDEwMjAxODA4NDBaMCMGCSqGSIb3DQEJ
# BDEWBBQtO6USJN5RZDezMXCWmDCH5NQsHTANBgkqhkiG9w0BAQUFAASCAQA05ss1
# yycVMQ6YtIPlS8NtToKksFENln0buWFbViNiQVc4/D+EcHwUO0MJl7NULW8bA7Wf
# VGuyRZEmkjT2XMRm4nHBqJVEukv69HWMcWAOcwoMVF4bjErrcKsKaJ5dqKT9s1V7
# MeDjSZQdKk0UWXgRY++d4y4LvDJLYKbLna1QY19VagYHfpLCTXf2TihUeDhhEGXK
# qNBasxexX2ybj8rSK/wOVcNnei8ejjFIC7BHpiOhsByNvWn+PhzlwUpNU6H3/L8x
# igHks/Ec3ILaU5M0xswOUq2pyyYwNRPK9uy3BnZS04GOFkC5tl9Y9+eOMEwzlgKv
# 5TK3gdJTegCP+WRP
