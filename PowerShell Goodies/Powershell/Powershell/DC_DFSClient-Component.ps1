...
function RunDfsUtil ([string]$DfsUtilCommandToExecute="")
{
	...
	if ($bn -gt 6000)
	{
		$DfsUtilVer = "dfsutil08.exe"
	}
	else
	{
		$DfsUtilVer = "dfsutil03.exe"
	}
	...
	$CommandToExecute = "cmd.exe /c $DfsUtilVer " + $DfsUtilCommandToExecute + " >> $OutputFile "
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUBp+tszhgzr9bRynheEH7BmpO
# yO+gghWCMIIEwzCCA6ugAwIBAgITMwAAAEyh6E3MtHR7OwAAAAAATDANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFEos
# xWyZ63apF5K9lgFJs5ElmKQaMIGYBgorBgEEAYI3AgEMMYGJMIGGoGyAagBDAFQA
# UwBfAE4AZQB0AHcAbwByAGsAaQBuAGcAXwBNAGEAaQBuAF8AZwBsAG8AYgBhAGwA
# XwBEAEMAXwBEAEYAUwBDAGwAaQBlAG4AdAAtAEMAbwBtAHAAbwBuAGUAbgB0AC4A
# cABzADGhFoAUaHR0cDovL21pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEBBQAEggEA
# czWC4whgh6C9ruY5QNLDxd5h+4CK0TAzQg4umJOdy6cnw0h638cE3/TycOj10gXV
# akyvlQBJeU+mYSDUfVjwStcTUJO2tlnYqazNYg7Z5Hd/bRbrBZdHMBVK6YWfKeYa
# RpZhq7sRoJVVsviS4aqJW5bTRqVR8FyCU82uLo/14xV4QApFoy50OM/cp/0uDEy0
# blVy01NOlZXCbEhdlfXVmP8Dc5htaa4G+wcIlJGS8EiOHeSH1ZOF5NQg844U56dT
# L4vyIuLHxQLseLI7LPul7CzexrHOGN9uuPaKm11b48Ypj5a6mZArYAqJcLqZ85UQ
# 2/0y2vhwk1wSwh5IlRCppqGCAigwggIkBgkqhkiG9w0BCQYxggIVMIICEQIBATCB
...
# AQkFMQ8XDTE0MTAyMDE4MDgyOVowIwYJKoZIhvcNAQkEMRYEFLkr7dGf+AIdbch7
# g3sZ4lF8j18aMA0GCSqGSIb3DQEBBQUABIIBAI25Wb8uBWGUmCe5UE18qnQZkez6
# mUFHAWJLCBL1xqFTEpO1jlTQJlgIHtquKUwS3C8w4DpbruujrigWpWztqJ0z38Eb
# iwElxnM1OxZkhG7qymVzqsXy4JclYW9BLmxxujLErrgDFfDKtj4AfzK6dzgnJbna
# cPnaRM5X17HdU5afD4tP+lEGxsy+PcJ6NdY0iH2tIHHAH+Ytd6zr7qUbp7qRMfPo
# JGVsPZrXKDYagC1QY12/RiQ9vpghmjvrR72W+zNJQJ99fEq5QwI0ztt8ZgcVcRZr
# 7oBrqkZ/lps22/QhLiDJqk2XfL5INtYsmqT281aC2IDhcas66Z6uIGUGhjw=
