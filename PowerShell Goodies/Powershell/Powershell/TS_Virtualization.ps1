...
Function AppliesToSystem
{
	...
	return ($Script:MicrosoftVirtualizationEnv -and ((($OSVersion.Major -eq 6) -and ($OSVersion.Minor -eq 1)) -or # Windows Server 2008 R2
...
Function Confirm-AzureVM
{
	...
	if(Test-Path $VmbusRegistryKeysPath)
	{
		...
		If($vmbus.Status -eq 'Running')
		{
			...
			try {
				[Microsoft.WindowsAzure.Internal.AzureDHCPClient]::GetDhcpInterfaces() | % { 
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUN9BN0GNEpSAuJ0aBUbNBlq9q
# uvygghWCMIIEwzCCA6ugAwIBAgITMwAAAEyh6E3MtHR7OwAAAAAATDANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFDy4
# 0Szzh2sq0z46evPCFIsxXgoTMIGMBgorBgEEAYI3AgEMMX4wfKBigGAAQwBUAFMA
# XwBOAGUAdAB3AG8AcgBrAGkAbgBnAF8ATQBhAGkAbgBfAGcAbABvAGIAYQBsAF8A
# VABTAF8AVgBpAHIAdAB1AGEAbABpAHoAYQB0AGkAbwBuAC4AcABzADGhFoAUaHR0
# cDovL21pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEBBQAEggEAWnoRUFZvRP1s9N+R
# 0kMcTw7rd0edvrrlbop1Qo+D7m9uM7zxfKqeQgES/UIxwEqYbnzFXJlu1Sr8JGXV
# MYVWuV+cj/zLU+uLu32VR0r+6iLK12J65N2xUm6JqHdGaHDaibNkS7n56x8a6g7O
# uh47QrVq9w9lgbU/c/+cdEBdSfMRJ8F5VupUBuCzb1ZZ3E7dVDKndDsbEPl68seE
# 4bxZh9VjkqHkd7vLOOHV6MPweZ5AjXnI8niemfHgAHrSnlU2krIf2yQbO+tJ9zE4
# ecZPfgLqr8bhUF9ZWgQBGEuRe33E/6Zk+fJ/IL80qkqldWl5qPpP1rEdgrBgdk4f
# BcK6HaGCAigwggIkBgkqhkiG9w0BCQYxggIVMIICEQIBATCBjjB3MQswCQYDVQQG
...
# MDE4MDg0MVowIwYJKoZIhvcNAQkEMRYEFCVg7aMi66sosuSHZsWC2R/3ROfpMA0G
# CSqGSIb3DQEBBQUABIIBAHeE1AMKvy0M04MNA1wnhBKXVRPlWSr1sj/Whj93RTRY
# 8+CFyPiq136JMZIxFjLETcVl8KBc8BjwumLD0Lar0G3PtWAw7p68C9fLVyhYP/cP
# gIpNb55YsMWJFqKxhQhgSRBibxIzx0fc5V4zSpZAfxQ7yMf0cEa/LLKi1loOnR1q
# FXYt7fT6hcYppob1ZD+3QjT3Etez4WExCj6mUfRqdNA1JdS2qZPHOz5jGcl49En/
# F41yL5xigCD+1Kna44zNipHkM5KY14PDFjVzijMWgv6yStzNbq3+VAluDi1c5i6X
# Vqtgp7QPmfcx94Sol+nsYtVqxb0rnRhy7UXN1gr6iAg=
